          ...
          onPanUpdate: (details) {
            ...
            if (details.delta.dx < 0) {
              Navigator.of(context)
                  .push(CupertinoPageRoute(builder: (context) => Intro3()));
            }
          },
          child: Container(
            child: Stack(
                        ...
                        children: [
                          ...
                          Align(
                            ...
                            child: Container(
                              ...
                              child: Text(
                                'Konsultasi masalah kesehatan Anda tanpa datang langsung ke klinik',
                                style: TextStyle(
                                  fontSize: 16,
                                  fontFamily: 'Roboto',
                                  color: Colors.white,
                ...
                Positioned(
                  ...
                  child: Container(
                    ...
                    child: Column(children: [
                      ...
                      SizedBox(height: 100),
                      SvgPicture.asset('assets/illustrations/intro_2.svg')
                    ]),
                  ),
                ),
              ],
